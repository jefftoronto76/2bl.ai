 ...
 * ─────────────────────────────────────────────────────────────────
 * Renders at the bottom of the How-it-works block, below the deliverables
 * tray. Auto-advances every 6s, pauses on hover, exposes dot controls.
 *
 * Headshots at /sage/jefflougheed/headshots/<First>_<Initial>.jpeg.
 * When `image` is omitted the avatar falls back to the person's initials.
 */
...
const HEADSHOT_DIR = '/sage/jefflougheed/headshots'
...
const FEATURED: Featured[] = [
  {
    ...
    title: 'CEO',
    company: 'Keyhole',
    image: `${HEADSHOT_DIR}/Saif_A.jpeg`,
  },
  {
    quote:
    ...
    title: 'President',
    company: 'Trapeze',
    image: `${HEADSHOT_DIR}/Rick_B.jpeg`,
  },
  {
    quote:
    ...
    company: 'Keyhole',
    image: `${HEADSHOT_DIR}/Iara_R.jpeg`,
  },
  {
    quote:
    ...
    company: 'RouteThis',
    image: `${HEADSHOT_DIR}/Ryan_M.jpeg`,
  },
]
