...
/*
  ...
  Token notes: generic re-scoped tokens (surface, accent) + route-scoped
  lg-* tokens from app/legacy/globals.css. Accent alpha via rgb(var(--color-accent) / x)
  where Tailwind's /opacity isn't convenient inline. CTAs stay as `#`
  placeholders — this standalone marketing route has no chat store wired.
*/
...
function useReveal() {
  ...
  useEffect(() => {
    ...
    if (!el) return
    const reveal = () => el.classList.add('lg-visible')
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-6 flex items-center justify-between h-16">
        ...
        <a
          href="/legacy"
          className="flex items-center gap-2.5 text-lg-text-primary no-underline"
          ...
          {navLinks.map((link) => (
            <li key={link.label}>
              <button
                ...
                className="font-body text-[15px] font-medium text-lg-text-muted hover:text-accent transition-colors bg-transparent border-0 cursor-pointer p-0 whitespace-nowrap"
              >
                {link.label}
              </button>
            </li>
        ...
        <div className="flex items-center gap-2 sm:gap-3.5">
          <a
            href="#"
            className="hidden md:inline-flex font-body text-[15px] font-medium text-lg-text-muted hover:text-lg-text-primary transition-colors items-center"
          >
            Sign up
          </a>
          <a
            href="#"
            className="font-body text-[15px] font-semibold bg-accent text-white px-4 rounded-[10px] hover:bg-lg-accent-hover transition-colors min-h-[44px] flex items-center whitespace-nowrap"
          >
            Start Your Story
          </a>
          ...
          {/* Mobile hamburger */}
          <button
            className="md:hidden flex items-center justify-center w-11 h-11 rounded-[10px] border border-accent/25 text-lg-text-primary bg-transparent"
        ...
        <ul className="list-none m-0 p-0 px-6 pt-3 pb-5 flex flex-col">
          {navLinks.map((link) => (
            <li key={link.label}>
              <button
                onClick={() => go(link.target)}
                className="w-full text-left font-display text-lg font-medium text-lg-text-primary py-[15px] min-h-[44px] border-b border-lg-border bg-transparent border-0 cursor-pointer"
              >
                {link.label}
              </button>
            </li>
          ...
          <li>
            <a
              href="#"
              className="block font-display text-lg font-medium text-lg-text-muted py-[15px] min-h-[44px] flex items-center"
        ...
        return (
          ...
          >
            ...
            <div className="min-w-0 flex flex-col gap-1">
              <span className="font-display italic text-lg-text-primary" style={{ fontSize: 23, lineHeight: 1 }}>
                {e.name}
              </span>
              <span
                className="font-mono uppercase text-lg-text-muted whitespace-nowrap"
...
function HeroSection() {
  return (
    <section className="pt-32 pb-24 px-6" aria-label="Hero">
      <div className="mx-auto max-w-6xl lg-hero-grid">
        {/* Copy */}
        <div className="min-w-0">
          ...
          <h1
            className="font-display font-light text-lg-text-primary m-0 leading-[0.95] tracking-tight"
          ...
          <p className="font-body text-lg-text-muted m-0 mt-7 max-w-[480px]" style={{ lineHeight: 1.78, fontSize: 18 }}>
          ...
          <div className="flex flex-wrap items-center gap-4 mt-9">
            <a
              href="#"
              className="font-body text-base font-semibold bg-accent text-white px-7 rounded-[13px] hover:bg-lg-accent-hover transition-all duration-200 min-h-[52px] flex items-center shadow-lg hover:-translate-y-0.5"
            >
              Start Your Story
            </a>
            <button
              onClick={() => scrollTo('learn-more')}
              className="font-body text-base font-semibold text-accent hover:text-lg-text-primary px-7 rounded-[13px] border border-accent/40 hover:border-accent hover:bg-accent/10 transition-all duration-200 min-h-[52px] bg-transparent cursor-pointer"
            >
              Learn More
            </button>
          </div>
        ...
        {/* Visual — hidden ≤920px */}
        <div className="flex justify-center lg-fan-visible">
          <FormatFan />
        </div>
      </div>
      ...
      <style>{`
        ...
        @media (min-width: 921px) {
          .lg-hero-grid { grid-template-columns: 1.18fr 0.82fr; }
        }
        .lg-fan-visible { display: none; }
        @media (min-width: 921px) { .lg-fan-visible { display: flex; } }
      `}</style>
    </section>
  )
}
    ...
    >
      <div id="learn-more" className="mx-auto max-w-6xl">
        <div className="text-center mb-16">
          ...
          <h2
            id="what-heading"
            className="font-display font-light text-lg-text-primary m-0 mx-auto max-w-2xl leading-[1.12] tracking-tight"
          ...
          {HOW_CARDS.map((card) => {
            ...
            return (
              <div key={card.label} className="h-full flex flex-col">
                ...
                <div
                  className="relative h-full flex-1 overflow-hidden rounded-2xl bg-surface border border-lg-border"
                  style={{ padding: 30 }}
                >
                  <span
                  ...
                  <p className="font-body text-lg-text-muted m-0" style={{ fontSize: 17, lineHeight: 1.62 }}>
                    {card.body}
                  </p>
                </div>
              </div>
...
function TheBestPartsSection() {
  ...
  return (
    <section
      id="the-best-part"
      ref={ref as React.RefObject<HTMLElement>}
      className="lg-reveal py-24 px-6 scroll-mt-16 bg-surface border-y border-lg-border"
    ...
    >
      <div className="mx-auto max-w-5xl">
        <div className="text-center mb-14">
          ...
          <h2
            id="best-heading"
            className="font-display font-light text-lg-text-primary m-0 leading-[1.12] tracking-tight"
            style={{ fontSize: 'clamp(30px, 4.6vw, 60px)' }}
          >
            The Best Parts
          </h2>
        ...
        {/* Lead card */}
        <div
          className="rounded-[20px] bg-lg-background border border-accent/25 mb-[18px] flex flex-wrap items-center gap-7"
        ...
        >
          ...
          <div className="flex-1 min-w-0 basis-80">
            ...
            <h3
              className="font-display font-medium text-lg-text-primary m-0 mb-3.5 leading-[1.12]"
              style={{ fontSize: 'clamp(26px, 3.2vw, 36px)' }}
            >
              You don't have to be a writer.
            </h3>
            <p className="font-body text-lg-text-muted m-0 max-w-[620px]" style={{ fontSize: 17, lineHeight: 1.64 }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-[18px] mb-[18px]">
          {FEATURE_CARDS.map((card) => {
            const Icon = card.icon
            return (
              <div key={card.title} className="rounded-[18px] bg-lg-background border border-lg-border" style={{ padding: 30 }}>
                <span
                  className="flex items-center justify-center text-accent"
                ...
                <h3 className="font-display font-medium text-lg-text-primary m-0 mb-2.5 leading-[1.16]" style={{ fontSize: 25 }}>
                  {card.title}
                </h3>
                <p className="font-body text-lg-text-muted m-0" style={{ fontSize: 16, lineHeight: 1.6 }}>
                  {card.body}
                </p>
              </div>
            )
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-[18px]">
          ...
          <a
            href="#"
            className="rounded-[18px] bg-lg-background border border-lg-border block no-underline hover:border-accent/40 transition-colors"
            style={{ padding: 30 }}
          ...
          <div
            className="rounded-[18px] bg-lg-background border border-dashed border-accent/40 relative overflow-hidden"
            style={{ padding: 30 }}
          >
            ...
            <p className="font-body text-lg-text-muted m-0 mb-5" style={{ fontSize: 16, lineHeight: 1.6 }}>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="font-mono text-[9.5px] uppercase tracking-[0.14em] text-lg-text-muted">
    ...
    <div className="relative" style={{ width: 280, height: 380, perspective: 1400 }} aria-hidden>
      <div className="absolute inset-0" style={{ transform: 'rotateY(-16deg)', transformStyle: 'preserve-3d' }}>
        ...
        >
          ...
          <span className="font-display italic text-lg-text-primary text-center" style={{ fontSize: 44, lineHeight: 1 }}>
            Legacy
          </span>
          <div style={{ width: 40, height: 1, margin: '20px 0', background: 'rgb(var(--color-accent) / 0.25)' }} />
          <span className="font-display text-lg-text-muted" style={{ fontSize: 17 }}>
            Volume One
          </span>
        </div>
      </div>
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        <p
          className="font-body text-lg-text-muted text-center max-w-[600px] mx-auto mb-14"
        ...
        {/* Book feature card */}
        <div
          className="rounded-[24px] bg-surface border border-accent/25 shadow-sm mb-14 lg-book-grid"
        ...
        >
          <div className="lg-book-copy">
            ...
            <h3
              className="font-display font-normal text-lg-text-primary m-0 mb-4 leading-none"
              style={{ fontSize: 'clamp(40px, 6vw, 68px)' }}
            >
              The Book
            </h3>
            <p className="font-body text-lg-text-muted m-0 mb-7 max-w-[480px]" style={{ fontSize: 'clamp(17px, 2vw, 20px)', lineHeight: 1.62 }}>
            ...
            <div className="flex flex-wrap gap-3.5">
              {['Hardcover / paperback', 'On-demand'].map((tag) => (
                <span
                  key={tag}
                  className="inline-flex items-center gap-2 font-mono text-xs text-lg-text-primary border border-accent/25 rounded-full px-3.5 py-2"
          ...
          <div className="lg-book-visual flex items-center justify-center">
            <BookCover />
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 mb-6">
          <span className="font-mono text-[10px] uppercase tracking-[0.24em] text-lg-text-muted whitespace-nowrap">
            Other ways to share it
          </span>
          <span className="flex-1 h-px bg-lg-border" />
        </div>
        <div className="lg-format-grid">
          {OTHER_FORMATS.map((fmt) => {
            const Icon = fmt.icon
            return (
              <div key={fmt.name} className="rounded-2xl bg-surface border border-lg-border" style={{ padding: '24px 22px' }}>
                <span
                  className="flex items-center justify-center text-accent"
                ...
                <p className="font-display font-medium text-lg-text-primary m-0 mb-2" style={{ fontSize: 22 }}>
                  {fmt.name}
                </p>
                <p className="font-mono text-[10px] uppercase tracking-widest text-lg-text-muted m-0">{fmt.tag}</p>
              </div>
            )
          })}
        </div>
      ...
      <style>{`
        .lg-book-grid { display: grid; grid-template-columns: 1fr; gap: 2.5rem; align-items: center; }
        @media (min-width: 821px) {
          .lg-book-grid { grid-template-columns: 1.05fr 0.95fr; gap: clamp(32px, 5vw, 64px); }
        }
        .lg-book-copy { order: 2; text-align: center; }
        .lg-book-visual { order: 1; }
        @media (min-width: 821px) {
          .lg-book-copy { order: 0; text-align: left; }
          .lg-book-copy p { margin-left: 0; margin-right: 0; }
          .lg-book-visual { order: 0; }
        }
        .lg-book-copy.lg-book-copy p { margin-left: auto; margin-right: auto; }

        .lg-format-grid { display: grid; grid-template-columns: 1fr; gap: 1rem; }
        @media (min-width: 561px) { .lg-format-grid { grid-template-columns: 1fr 1fr; } }
        @media (min-width: 921px) { .lg-format-grid { grid-template-columns: repeat(4, 1fr); } }
      `}</style>
    </section>
  )
}
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-2xl">
        ...
        <p
          className="font-display italic font-light text-lg-text-primary m-0 mb-10 leading-[1.2]"
        ...
        <a
          href="#"
          className="inline-flex items-center font-body text-base font-semibold bg-accent text-white px-8 rounded-[13px] hover:bg-lg-accent-hover transition-all duration-200 min-h-[52px] shadow-lg hover:-translate-y-0.5"
        >
          Start Your Story
        </a>

        <p className="font-mono text-[13px] tracking-[0.06em] text-lg-text-muted m-0 mt-[18px]">
...
function Footer() {
  return (
    <footer className="border-t border-accent px-6 pt-14 pb-10 bg-transparent">
      <div className="mx-auto max-w-6xl">
        <div className="lg-footer-grid mb-12">
          {/* Brand */}
          <div>
            <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-accent m-0 mb-2">
              Brought to you by
            </p>
            <p className="font-display text-lg-text-primary m-0 mb-3" style={{ fontSize: 26, fontWeight: 500, lineHeight: 1.1 }}>
              Second Brain <em className="text-accent not-italic font-normal italic">Labs</em>
            </p>
            <p className="font-body text-lg-text-muted m-0 max-w-sm" style={{ fontSize: 15, lineHeight: 1.6 }}>
          ...
          {/* Learn */}
          <div>
            <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-lg-text-muted m-0 mb-4">Learn</p>
            <ul className="list-none m-0 p-0 flex flex-col gap-3">
              {[
                ...
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="font-body text-lg-text-primary hover:text-accent transition-colors no-underline"
                    style={{ fontSize: 15 }}
                  >
                    {link.label}
                  </a>
          ...
          {/* Contact */}
          <div>
            <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-lg-text-muted m-0 mb-4">Contact</p>
            <ul className="list-none m-0 p-0 flex flex-col gap-3">
              <li>
                <a
              ...
              <li>
                <span className="font-body text-lg-text-muted" style={{ fontSize: 15 }}>
                  Toronto · Remote
                </span>
              </li>
            </ul>
        ...
        <div className="border-t border-lg-border pt-7 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <p className="font-body text-lg-text-muted m-0" style={{ fontSize: 14 }}>
            © 2026 Second Brain Labs, Inc.
          </p>
          <p className="font-display italic text-lg-text-muted m-0" style={{ fontSize: 15 }}>
      ...
      <style>{`
        .lg-footer-grid { display: grid; grid-template-columns: 1fr; gap: 2.5rem; }
        @media (min-width: 461px) { .lg-footer-grid { grid-template-columns: 1fr 1fr; } }
        @media (min-width: 761px) { .lg-footer-grid { grid-template-columns: 1.4fr 1fr 1fr; } }
      `}</style>
    </footer>
  )
}
