...
> **Plan-mode note.** This file is the deliverable draft. On approval, the only
> action is to commit it (unchanged in substance) as
> `Design Handovers/traffic_cop_design_2026-09-05.md` on branch
> `claude/traffic-cop-prompt-context-czvj9i`, push, and stop for review.
> Nothing else is built from this pass.
