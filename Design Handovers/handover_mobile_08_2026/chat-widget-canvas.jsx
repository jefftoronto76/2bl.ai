...
(function () {
  ...
  function StoryChat() {
    ...
    const panelOpen = !!openMemId || sessionListOpen;
    ...
    const sidebarEl = (
      <Sidebar width={isMobile ? 264 : (panelOpen ? 60 : sideW)} sessions={sessions} activeId={activeId} onNew={newChat} memories={memories}
