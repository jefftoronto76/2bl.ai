...
function Deck({ memories, story, storyId, onOpen, onReorder, onEditStub, onAllStories, onClose, onInvite, onAddMemories, compact }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', minHeight: 0 }}>
      <header style={{ ...scHeader, gap: 10 }}>
        ...
        {onAddMemories && <button aria-label="Add memories to this story" title="Add memories to this story" onClick={onAddMemories} style={{ ...scGhost, padding: 8 }} onMouseEnter={ghostOn} onMouseLeave={ghostOff}><SIcon n="plus" s={15} /></button>}
        <button aria-label="Share this story" title="Share this story" onClick={onInvite} style={{ ...scGhost, padding: 8 }} onMouseEnter={ghostOn} onMouseLeave={ghostOff}><SIcon n="users" s={15} /></button>
...
function CardView({ mem, index, total, parent, stories, onBack, onPage, onEdit, onTalk, onFork, onDelete, onMoveStory, onCreateStory }) {
