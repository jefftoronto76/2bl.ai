...
//
// ▶ INVITE-TRACKING ADDITIONS (Option B) live in the ‹invite tracking› block at the
//   bottom. Everything above is unchanged — this is a drop-in replacement.
 ...
 *   webhook, then change this to:
 *     ['sent', 'delivered', 'opened', 'accepted']
