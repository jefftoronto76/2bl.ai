 ...
 *
 * IMPORTANT: on mount, scroll the nearest scrollable ancestor so this
 * popover is actually visible — in a long conversation it can otherwise
 * render below the fold with no indication anything happened. Don't rely on
 * the transcript's bottom-pinned auto-scroll; that only fires on new
  ...
  return (
    ...
    >
            ...
            <button
              ...
              className={
                active
                  ...
                  : 'rounded-full border border-border px-2.5 py-1.5 text-[12.5px] font-medium text-text-muted hover:border-border-strong'
              }
            >
              {r}
            </button>
      ...
      <textarea
        ...
        rows={2}
        className="mt-2 w-full resize-none rounded-lg border border-border bg-surface-2 p-2 text-[13px] text-text-primary outline-none"
      />
