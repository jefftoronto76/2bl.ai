...
// PATCH (README §11): useWidgetShell import + isExpanded/heroEngaged early
// return removed — the rail now stays visible during engaged Hero / open
// overlay. See handover-chat-widgets-main/README.md.
