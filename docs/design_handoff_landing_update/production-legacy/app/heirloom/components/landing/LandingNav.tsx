...
/*
  LandingNav — PRODUCTION FILE, UNCHANGED except branding.

  This is the live LandingNav.tsx verbatim. The ONLY edit vs. main is the brand
  wordmark "Heirloom" → "Legacy" (and its aria-label). Everything else — the nav
  links + targets, the Sign Up / Start Your Story wiring, every className, the
  scroll behavior, and the feather logo asset — is exactly as production.

  ⚠️ DO NOT modify the handlers or structure:
  • Sign Up          → setOAuthInProgress(true); openSignUp({ appearance: heirloomClerkAppearance })
