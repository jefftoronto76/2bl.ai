...
Object.assign(window, {
  TENANT_NAME, ADMIN_NAV, PROMPT_STUDIO_ITEMS, ADMIN_PAGE_TITLES, tokensFor,
  SESSION_STATUS_BADGE, INBOUND_CHATS,
  BLOCK_TYPES, BLOCK_TYPE_COLORS, BLOCK_TYPE_LABELS, BLOCK_TYPE_COMPILE_ORDER,
  formatTypeBadgeLabel, ORDERED_BLOCK_TYPES, BLOCK_BADGE, BLOCKS,
  HISTORY_STATUS_BADGE, COMPOSER_HISTORY, ASSETS,
  SAGE_PARAMETERS, OPEN_AS_OPTIONS, CHAT_THRESHOLDS, INVITE_GATE_ENABLED,
  THEME_TOKENS, THEME_FONT_OPTIONS,
  MASTER_PROMPT_VERSION, MASTER_PROMPT_UPDATED_AT, MASTER_PROMPT_CONTENT,
  SYSTEM_PROMPT_VERSION, SYSTEM_PROMPT_CONTENT, SYSTEM_PROMPT_HISTORY, COMPOSER_EXISTING,
});
