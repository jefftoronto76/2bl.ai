...
// Inline-style supplements for layout primitives Mantine v7 doesn't expose as
// props on Flex/Stack/Box. (Unchanged from the original page.)
...
// Next 15: searchParams is a Promise. For Next 14, drop the Promise wrapper
// and the `await` below.
export default async function BlocksPage({
  ...
  // Prompt sets feed the "Current Prompt Set" picker; the active set scopes the
  // blocks query. Falls back to tenant-wide blocks when no sets exist yet (i.e.
  // before the prompt_sets migration lands) so the page keeps working.
