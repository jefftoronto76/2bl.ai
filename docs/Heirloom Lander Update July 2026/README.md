...
## Overview
This package hands off four design updates for the **Legacy** marketing site (`app/legacy/` in `jefftoronto76/2bl.ai`) and the shared **Story chat** widget (`components/shells/membership/` — the drawer behind every "Start Your Story" button):
