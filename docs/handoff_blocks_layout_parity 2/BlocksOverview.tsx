...
//   Right card : TokenDonut → "Hover…" caption → type-chip legend (under the donut)
//
// NOTE: the previous version used ONE card wrapping a *bordered* inner grid (defGrid).
// That was the pixel mismatch — the design has two clean cards and borderless rows.
// defGrid is gone.
...
export function BlocksOverview({
  ...
  return (
    <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="md">
      ...
      {/* Right card — donut + caption + type legend under the donut */}
      <Card withBorder radius="md" p="lg" style={{ background: 'transparent' }}>
